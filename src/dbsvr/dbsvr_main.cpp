...
void Dispatch(const phxrpc::BaseRequest &req,
    ...
    DbsvrServiceImpl service(*service_args);
    DbsvrDispatcher dispatcher(service, args);

    phxrpc::BaseDispatcher<DbsvrDispatcher> base_dispatcher(
            dispatcher, DbsvrDispatcher::GetURIFuncMap());
